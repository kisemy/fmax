...
class CashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cash" do
    assert_difference('Cash.count') do
      post cashes_url, params: { cash: { balance: @cash.balance, bank_acc_no: @cash.bank_acc_no, name: @cash.name, posting_group: @cash.posting_group } }
    end
  ...
  test "should update cash" do
    patch cash_url(@cash), params: { cash: { balance: @cash.balance, bank_acc_no: @cash.bank_acc_no, name: @cash.name, posting_group: @cash.posting_group } }
