...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { balance: @bank.balance, bank_acc_no: @bank.bank_acc_no, name: @bank.name, posting_group: @bank.posting_group } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { balance: @bank.balance, bank_acc_no: @bank.bank_acc_no, name: @bank.name, posting_group: @bank.posting_group } }
