...
ActiveRecord::Schema.define(version: 2023_05_06_180242) do

  create_table "acccharts", force: :cascade do |t|
    t.text "account_name"
    t.text "type"
    t.text "categoty"
    t.text "class"
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.text "payment_account_description"
    t.text "prepared_by"
